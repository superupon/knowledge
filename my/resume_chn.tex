...
\begin{center}
    \textbf{\Huge \scshape 张玉晨} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{电话:13641784013}{+86 13641784013}
    $|$
    \faAt \hspace{.5pt} \href{邮件:superupon@126.com}{superupon@126.com}
    $|$
    \faMapMarker \hspace{.5pt} \href{地址:上海市嘉定区}{嘉定区}
\end{center}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      % \normalfont{(Admission rate: 0.09\%)}
        ...
        {软件工程学院   \hspace{150pt} \textbf{软件工程}}{2012.09 \textbf{--} 2015.03}
        {交通运输工程学院 \hspace{100pt} \textbf{交通信息与控制工程}}{2006.09 \textbf{--} 2011.06}
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{专业技能:}{ C/C++, C\#, Java, Python, Verilog, MATLAB, R} \\ \vspace{3pt}
